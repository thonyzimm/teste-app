...
-- server url
url = "http://devopsotserver.zapto.org"
...
motd = "Bem vindos ao DevOps Otserver."
motdnum = "1"

-- login message
loginmsg = "Bem vindos ao DevOps Otserver de Tibia."
